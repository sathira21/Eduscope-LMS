...
- **Projection**: We only select the fields required for the specific view (e.g., student view excludes correct answers).
- **Caching Strategy**: Considering Redis for high-frequency queries like quiz metadata.
